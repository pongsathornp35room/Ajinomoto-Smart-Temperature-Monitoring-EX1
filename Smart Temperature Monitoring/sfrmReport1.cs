    ...
    public partial class sfrmReport1 : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if(skyscrapers.Rows.Count > 0)
            {
                ...
                // Set header2 cells Merged
                worksheet.Cells.GetSubrange("B31:D31").Merged = true;  // Temp. #1
                worksheet.Cells.GetSubrange("E31:G31").Merged = true;  // Temp. #2
                worksheet.Cells.GetSubrange("H31:J31").Merged = true;  // Temp. #3

                worksheet.Cells.GetSubrange("B32:D32").Merged = true;  // Avg Temp. #1
                worksheet.Cells.GetSubrange("E32:G32").Merged = true;  // Avg Temp. #2
                worksheet.Cells.GetSubrange("H32:J32").Merged = true;  // Avg Temp. #3

                worksheet.Cells.GetSubrange("B33:D33").Merged = true;  // Max Temp. #1
                worksheet.Cells.GetSubrange("E33:G33").Merged = true;  // Max Temp. #2
                worksheet.Cells.GetSubrange("H33:J33").Merged = true;  // Max Temp. #3

                worksheet.Cells.GetSubrange("B34:D34").Merged = true;  // Min Temp. #1
                worksheet.Cells.GetSubrange("E34:G34").Merged = true;  // Min Temp. #2
                worksheet.Cells.GetSubrange("H34:J34").Merged = true;  // Min Temp. #3
                ...
                // Set summary header cells formatting.
                var summary_h_style = new CellStyle();
                summary_h_style.HorizontalAlignment = HorizontalAlignmentStyle.Center;
                summary_h_style.VerticalAlignment = VerticalAlignmentStyle.Center;
                //summary_h_style.FillPattern.SetSolid(SpreadsheetColor.FromArgb(255, 129, 129));
                summary_h_style.Font.Weight = ExcelFont.BoldWeight;
                //summary_h_style.Font.Color = SpreadsheetColor.FromName(ColorName.White);
                summary_h_style.NumberFormat = "00.00";
                worksheet.Cells.GetSubrange("A31:J31").Style = summary_h_style;
                worksheet.Cells.GetSubrange("A32:A34").Style = summary_h_style;

                // Set summary data cells formatting.
                var summary_d_style = new CellStyle();
                summary_d_style.HorizontalAlignment = HorizontalAlignmentStyle.Center;
                summary_d_style.VerticalAlignment = VerticalAlignmentStyle.Center;
                summary_d_style.NumberFormat = "00.00";
                worksheet.Cells.GetSubrange("B32:J34").Style = summary_d_style;
                ...
                //Write summary datasummary
                worksheet.Cells["A31"].Value = "Summary";
                worksheet.Cells["A32"].Value = "Avarage";
                worksheet.Cells["A33"].Value = "Maximum";
                worksheet.Cells["A34"].Value = "Minimum";

                worksheet.Cells["B31"].Value = "Temp. #1";
                worksheet.Cells["E31"].Value = "Temp. #2";
                worksheet.Cells["H31"].Value = "Temp. #3";

                worksheet.Cells["B32"].Value = daily_avg_temp1;
                worksheet.Cells["B33"].Value = daily_max_temp1;
                worksheet.Cells["B34"].Value = daily_min_temp1;

                worksheet.Cells["E32"].Value = daily_avg_temp2;
                worksheet.Cells["E33"].Value = daily_max_temp2;
                worksheet.Cells["E34"].Value = daily_min_temp2;

                worksheet.Cells["H32"].Value = daily_avg_temp3;
                worksheet.Cells["H33"].Value = daily_max_temp3;
                worksheet.Cells["H34"].Value = daily_min_temp3;
                ...
                // Summary
                worksheet.Cells.GetSubrange("A31", "J31").Style.Borders.SetBorders(
                    MultipleBorders.Outside, SpreadsheetColor.FromName(ColorName.Black), LineStyle.Thin);
                worksheet.Cells.GetSubrange("A32", "J32").Style.Borders.SetBorders(
                    MultipleBorders.Outside, SpreadsheetColor.FromName(ColorName.Black), LineStyle.Thin);
                worksheet.Cells.GetSubrange("A33", "J33").Style.Borders.SetBorders(
                    MultipleBorders.Outside, SpreadsheetColor.FromName(ColorName.Black), LineStyle.Thin);
                worksheet.Cells.GetSubrange("A34", "J34").Style.Borders.SetBorders(
                    MultipleBorders.Outside, SpreadsheetColor.FromName(ColorName.Black), LineStyle.Thin);
                worksheet.Cells.GetSubrange("A31", "A34").Style.Borders.SetBorders(
                    MultipleBorders.Outside, SpreadsheetColor.FromName(ColorName.Black), LineStyle.Thin);
                worksheet.Cells.GetSubrange("B31", "C34").Style.Borders.SetBorders(
                    MultipleBorders.Outside, SpreadsheetColor.FromName(ColorName.Black), LineStyle.Thin);
                worksheet.Cells.GetSubrange("E31", "G34").Style.Borders.SetBorders(
                    MultipleBorders.Outside, SpreadsheetColor.FromName(ColorName.Black), LineStyle.Thin);
                worksheet.Cells.GetSubrange("H31", "J34").Style.Borders.SetBorders(
                    MultipleBorders.Outside, SpreadsheetColor.FromName(ColorName.Black), LineStyle.Thin);
                ...
                try
                {
                    ...
                    string dt = "REPORT_TEMP_EX1" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".xlsx";
